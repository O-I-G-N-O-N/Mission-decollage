...
| Verbe action   | Condition de déclenchement                                        | Effet visuel                                                                   | Effet sonore                                                                                    | Effet interactif                                                                                                                                  |
| -------------- | ----------------------------------------------------------------- | ------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Observer**   | Les joueurs ont démarré le jeu                                    | Une explication du jeu est affiché à l’écran, indiquant les instructions pour naviguer la fusée | Sons d’environnement terrestres, voix de tutoriel, petite musique d’ambiance                    | Les joueurs sont invités à tester leur pouvoir sur la fusée                                                                                       |
...
| **Appuyer**    | Les joueurs essaient les boutons afin de voir/comprendre leur fonctionnement | Vue 3ᵉ personne de la fusée                                                    | bruits terrestres et de réacteurs si interactions avec les boutons/sliders                      | Permet aux intéracteur de se familiariser avec les commandes                                                                                      |
...
|
| **Tourner**    | Les joueurs essaient les clés rotatives afin de voir leur fonctionnement | Vue 3ᵉ personne de la fusée                                                    | bruits de fusée en rapport avec l'intéraction avec la clé rotative (dépend de l'action)                      | Permet aux intéracteur de se familiariser avec les commandes                                                                                      |
...
| **Appuyer**  | Les joueurs ont décollé    | Vue 3ᵉ personne de la fusée | Réacteurs, fusée, débris terrestres, communications tour de contrôle | appuyer sur les boutons aux bons moments afin de garder une bonne communication avec la tour de contrôle ou régler des problèmes liés à la fusée.          |
| **Tourner**  | Les joueurs ont décollé    | Vue 3ᵉ personne de la fusée | Réacteurs, fusée, débris terrestres, communications tour de contrôle | tourner les clés rotatives aux bons moments afin de garder une bonne communication avec la tour de contrôle ou régler des problèmes liés à la fusée.          |
...
| M5Stack RGB LED Strip 12V – x1                              | 5.95 USD ≈ 8.20 CAD      | **8.20 CAD**     | 0 CAD (emprunt école) | [Lien](https://shop.m5stack.com/products/digital-rgb-led-weatherproof-strip-sk6812)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
